            ...
            <div className="relative">
              ...
              <div className="relative bg-gradient-to-br from-blue-50 to-purple-50 dark:from-gray-700 dark:to-gray-600 p-8 rounded-lg shadow-xl">
                <p className="text-lg text-gray-700 dark:text-gray-200 leading-relaxed mb-6">
                  I am an aspiring Full Stack Developer with a strong foundation in the MERN stack (MongoDB, Express.js, React, Node.js) and a passion for building seamless, efficient, and user-focused web applications.
                </p>
                <p className="text-lg text-gray-700 dark:text-gray-200 leading-relaxed">
                  Adept at translating ideas into responsive and scalable digital solutions that prioritize performance, data privacy, and intuitive user experiences. Driven by curiosity and continuous learning, I aim to leverage technology to solve real-world problems through clean architecture, optimized backend systems, and engaging front-end design.
                </p>
              </div>
            </div>
          </div>
