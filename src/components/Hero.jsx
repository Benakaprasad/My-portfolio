        ...
        <div className="text-center">
          ...
          >
            ...
            <p className="text-lg sm:text-xl text-gray-600 dark:text-gray-400 max-w-3xl mx-auto mb-8">
              Building seamless, efficient web applications with the MERN stack. Specialized in creating responsive and scalable digital solutions that prioritize performance, data privacy, and intuitive user experiences.
            </p>
          </div>
